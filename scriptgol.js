document.addEventListener('DOMContentLoaded', () => {
  ...
  function displayMushroom() {
    ...
    image.src = `images/gol/${mushroom.images[currentImageIndex]}`;  // Updated path
  ...
  prevButton.addEventListener('click', () => {
    ...
    modalImg.src = `images/gol/${mushrooms[currentMushroomIndex].images[currentImageIndex]}`;  // Updated path
  });
